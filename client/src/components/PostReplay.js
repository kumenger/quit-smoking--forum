          ...
          <CommentBox
            ...
            currentidfromparent={
              ...
              (props.mongologinreduxer.isAuthenticated &&
                props.mongologinreduxer.user.id === props.post[id].userID)
                ? true
                : false
            }
            ...
            avaterPic={
              ...
              !props.facebookloginreducer.resp.error
                ...
                : `https://ui-avatars.com/api/?name=${props.post[id].name}&size=64&font-size=0.2&background=${color.current}`
            }
                ...
                return (
                  <RepliyListcommnetbox
                    ...
                    currentidfromparent={
                      ...
                      (props.mongologinreduxer.isAuthenticated &&
                        props.mongologinreduxer.user.id === x.userID)
                    }
                    totallikes={x.likes}
                    curentlikes={x.likes}
                    nestedindex={x._id}
                    ...
                    avaterPic={
                      ...
                      !props.facebookloginreducer.resp.error
                        ? props.facebookloginreducer.resp.picture.data.url
                        : `https://ui-avatars.com/api/?name=${x.replayername} &size=64&font-size=0.2&background=${colr2.current}`
                    }
                  />
                );
              }
