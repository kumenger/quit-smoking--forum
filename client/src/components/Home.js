...
Felt So Good.</h2>
                    ...
                    <h3 style={{ color: "brown", fontFamily: "", fontSize: "14px",textAlign:"center" }}>
                        <strong>After 1 hour Quit Smoking...</strong>
                    </h3>
                    <p classname="  text-left" style={{ color: "", fontFamily: "", fontSize:"14px", fontWeight:"bolder"}}>
                        In as little as 20 minutes after the last cigarette is smoked, the
                                      heart rate drops and returns to normal <img src="https://img.icons8.com/bubbles/30/null/happy.png"/>. Blood pressure begins to
                    ...
                    <p classname="text-left" style={{ color: "",fontSize:"14px", fontWeight:"bolder", fontFamily: "", }}>
 ...
 <div style={{width:"50%"}}>
    <img src='https://i.ibb.co/RzZB4V0/tobaccosupport-TN.jpg'/>
